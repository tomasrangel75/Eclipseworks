...
namespace Eclipseworks.Persistence.Migrations
{
    ...
    [Migration("20231203195052_Initial")]
            ...
            modelBuilder.Entity("Eclipseworks.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CriadoPor = 1,
                            DataCriacao = new DateTimeOffset(new DateTime(2023, 12, 3, 16, 50, 52, 312, DateTimeKind.Unspecified).AddTicks(2437), new TimeSpan(0, -3, 0, 0, 0)),
                            Nome = "Admin",
                            Sobrenome = ""
                        },
                        new
                        {
                            Id = 2,
                            CriadoPor = 1,
                            DataCriacao = new DateTimeOffset(new DateTime(2023, 12, 3, 16, 50, 52, 312, DateTimeKind.Unspecified).AddTicks(2490), new TimeSpan(0, -3, 0, 0, 0)),
                            Nome = "User1",
                            Sobrenome = ""
                        },
                        new
                        {
                            Id = 3,
                            CriadoPor = 1,
                            DataCriacao = new DateTimeOffset(new DateTime(2023, 12, 3, 16, 50, 52, 312, DateTimeKind.Unspecified).AddTicks(2495), new TimeSpan(0, -3, 0, 0, 0)),
                            Nome = "User2",
                            Sobrenome = ""
                        });
                });
